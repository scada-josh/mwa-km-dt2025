...
🎉📚 “น้องหนอน Knowledge” ขอแอบกระซิบ...
ตอนนี้ยังซุ่มอยู่หลังเวที กำลังเตรียมตัวให้พร้อมสุดๆ
อีกไม่นาน! คุณจะได้พูดคุยกับ AI ผู้ช่วยแสนรู้ ที่เชื่อมต่อกับ คลังความรู้จาก KM/IM Portal ของ กปน.
ตอบคำถามแบบเข้าใจง่าย ค้นหาความรู้แบบเรียลไทม์ ✨

💡📡
และที่สำคัญ... “น้องหนอน Knowledge” เป็นหนึ่งในนวัตกรรมที่สายงานเทคโนโลยีดิจิทัลของ กปน. มุ่งมั่นพัฒนาขึ้น
ร่วมกับสายงานอื่นๆ ภายใน กปน. เพื่อเสริมพลังการเรียนรู้ ทำให้การเข้าถึงความรู้เป็นเรื่องง่าย สนุก และมีชีวิตชีวา! สนับสนุนการทำงาน และขับเคลื่อนองค์กรสู่ความก้าวหน้าอย่างยั่งยืน

🎈🌟
วันนี้ขอให้ทุกท่านสนุกกับกิจกรรม เดินบูธให้ครบ สะสมความรู้ให้เต็ม Passport 💼 ตอบคำถามให้ได้
เก็บความรู้ให้เต็มหัวใจ แล้วลุ้น Lucky Draw ไปด้วยกัน!
KM Day วันนี้ เราหวังว่าคุณจะได้ทั้ง แรงบันดาลใจ ความรู้ และรอยยิ้ม กลับบ้านนะครับ 😊💙
              `);
          } else {
